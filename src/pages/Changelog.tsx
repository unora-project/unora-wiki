...
import {
  Swords, Compass, Search as SearchIcon, Shield, Map, Hammer, ImageIcon,
  Settings, Calculator, Sparkles, ScrollText, BarChart3,
  Castle, ClipboardList, PartyPopper, type LucideIcon,
} from 'lucide-react'
